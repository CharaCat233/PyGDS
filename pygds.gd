...
class Lexer:
		...
		match c:
			...
			'\\':
				...
				if peek() == '\n':
					...
					report.error("SyntaxError: unexpected character after line continuation character")
			'"', "'": string(c)
			_:
	...
	const _NAMED_ESCAPES = {
		...
		"LINE FEED": 10, "FORM FEED": 12, "CARRIAGE RETURN": 13,
		"ESCAPE": 27, "SPACE": 32, "DELETE": 127,
		"EXCLAMATION MARK": 33, "QUOTATION MARK": 34, "NUMBER SIGN": 35,
		"DOLLAR SIGN": 36, "PERCENT SIGN": 37, "AMPERSAND": 38,
		"APOSTROPHE": 39, "LEFT PARENTHESIS": 40, "RIGHT PARENTHESIS": 41,
		"ASTERISK": 42, "PLUS SIGN": 43, "COMMA": 44, "HYPHEN-MINUS": 45,
		"FULL STOP": 46, "SOLIDUS": 47,
		"DIGIT ZERO": 48, "DIGIT ONE": 49, "DIGIT TWO": 50, "DIGIT THREE": 51,
		"DIGIT FOUR": 52, "DIGIT FIVE": 53, "DIGIT SIX": 54, "DIGIT SEVEN": 55,
		"DIGIT EIGHT": 56, "DIGIT NINE": 57,
		...
		"LATIN SMALL LETTER a": 97, "LATIN SMALL LETTER b": 98, "LATIN SMALL LETTER c": 99, "LATIN SMALL LETTER d": 100, "LATIN SMALL LETTER e": 101, "LATIN SMALL LETTER f": 102, "LATIN SMALL LETTER g": 103, "LATIN SMALL LETTER h": 104, "LATIN SMALL LETTER i": 105, "LATIN SMALL LETTER j": 106, "LATIN SMALL LETTER k": 107, "LATIN SMALL LETTER l": 108, "LATIN SMALL LETTER m": 109, "LATIN SMALL LETTER n": 110, "LATIN SMALL LETTER o": 111, "LATIN SMALL LETTER p": 112, "LATIN SMALL LETTER q": 113, "LATIN SMALL LETTER r": 114, "LATIN SMALL LETTER s": 115, "LATIN SMALL LETTER t": 116, "LATIN SMALL LETTER u": 117, "LATIN SMALL LETTER v": 118, "LATIN SMALL LETTER w": 119, "LATIN SMALL LETTER x": 120, "LATIN SMALL LETTER y": 121, "LATIN SMALL LETTER z": 122,

		"COLON": 58, "SEMICOLON": 59, "LESS-THAN SIGN": 60, "EQUALS SIGN": 61,
		"GREATER-THAN SIGN": 62, "QUESTION MARK": 63, "COMMERCIAL AT": 64,
		"LEFT SQUARE BRACKET": 91, "REVERSE SOLIDUS": 92,
		"RIGHT SQUARE BRACKET": 93, "CIRCUMFLEX ACCENT": 94, "LOW LINE": 95,
		"GRAVE ACCENT": 96, "LEFT CURLY BRACKET": 123, "VERTICAL LINE": 124,
		"RIGHT CURLY BRACKET": 125, "TILDE": 126,
		"COPYRIGHT SIGN": 169, "REGISTERED SIGN": 174, "DEGREE SIGN": 176,
		"PLUS-MINUS SIGN": 177, "MICRO SIGN": 181, "PILCROW SIGN": 182,
		"MIDDLE DOT": 183, "CENT SIGN": 162, "POUND SIGN": 163,
		"CURRENCY SIGN": 164, "YEN SIGN": 165, "SECTION SIGN": 167,
		"INVERTED QUESTION MARK": 191, "MULTIPLICATION SIGN": 215,
		"DIVISION SIGN": 247, "NO-BREAK SPACE": 160, "NOT SIGN": 172,
		"SOFT HYPHEN": 173, "MACRON": 175, "ACUTE ACCENT": 180,
		"CEDILLA": 184, "BROKEN BAR": 166, "DIAERESIS": 168,
		"FEMININE ORDINAL INDICATOR": 170, "MASCULINE ORDINAL INDICATOR": 186,
		"LEFT-POINTING DOUBLE ANGLE QUOTATION MARK": 171,
		"RIGHT-POINTING DOUBLE ANGLE QUOTATION MARK": 187,
		"EURO SIGN": 8364, "TRADE MARK SIGN": 8482,
		"LEFT SINGLE QUOTATION MARK": 8216, "RIGHT SINGLE QUOTATION MARK": 8217,
		"LEFT DOUBLE QUOTATION MARK": 8220, "RIGHT DOUBLE QUOTATION MARK": 8221,
		"DAGGER": 8224, "DOUBLE DAGGER": 8225, "BULLET": 8226,
		"HORIZONTAL ELLIPSIS": 8230, "PER MILLE SIGN": 8240,
		"PRIME": 8242, "DOUBLE PRIME": 8243,
		"EN DASH": 8211, "EM DASH": 8212, "MINUS SIGN": 8722,
		"INFINITY": 8734, "NOT EQUAL TO": 8800,
		"LESS-THAN OR EQUAL TO": 8804, "GREATER-THAN OR EQUAL TO": 8805,
		"IDENTICAL TO": 8801,
		"LEFTWARDS ARROW": 8592, "UPWARDS ARROW": 8593,
		"RIGHTWARDS ARROW": 8594, "DOWNWARDS ARROW": 8595,
		"BLACK STAR": 9733, "WHITE STAR": 9734,
		"BLACK HEART SUIT": 9829, "BLACK DIAMOND SUIT": 9830,
		"BLACK CLUB SUIT": 9827, "BLACK SPADE SUIT": 9824,
		"BLACK SUN WITH RAYS": 9728, "SNOWMAN": 9731,
		"CHECK MARK": 10003, "BALLOT X": 10007,
	}

	## 将字符串中的转义序列还原为实际字符 [br]
	## 支持 \n \t \r \\ \" \' \a \b \f \v \xNN \NNN \uNNNN \UXXXXXXXX \N{名称} [br]
	## bytes 语义: \u \U \N 不解码 (CPython 原样保留), 八进制值按单字节截断 [br]
	## [param s] 包含转义序列的原始字符串 [br]
	## [param is_raw] 是否为原始字符串 (r 前缀, 不做转义) [br]
	## [param is_bytes] 是否为 bytes 字面量 (b 前缀) [br]
	## [returns] 转义后的字符串
		...
		while i < n:
			...
			match next_ch:
				...
				'b':
					...
					i += 2
				'f':
					result += String.chr(12)
					i += 2
				'v':
					result += String.chr(11)
					i += 2
				'\n':
					# 字符串内的反斜杠续行: 两个字符都丢弃 (CPython 语义)
					i += 2
				'x':
					var hex_2 = _take_hex(s, i + 2, 2)
					if hex_2[1] < 2:
						report.error("SyntaxError: truncated \\xXX escape")
						return result
					if not _check_cp(hex_2[0]):
						return result
					result += String.chr(hex_2[0])
					i += 2 + 2
				'u':
					var hex_4 = _take_hex(s, i + 2, 4)
					if hex_4[1] < 4:
						report.error("SyntaxError: truncated \\uXXXX escape")
						return result
					if not _check_cp(hex_4[0]):
						return result
					result += String.chr(hex_4[0])
					i += 2 + 4
				'U':
					var hex_8 = _take_hex(s, i + 2, 8)
					if hex_8[1] < 8:
						report.error("SyntaxError: truncated \\UXXXXXXXX escape")
						return result
					if hex_8[0] > 0x10FFFF:
						report.error("SyntaxError: illegal Unicode character")
						return result
					if not _check_cp(hex_8[0]):
						return result
					result += String.chr(hex_8[0])
					i += 2 + 8
				'N':
					var named = _take_named_escape(s, i + 2)
					if named == null:
						report.error("SyntaxError: unknown Unicode character name")
						return result
					if not _check_cp(named[0]):
						return result
					result += String.chr(named[0])
					i = named[1]
				'0', '1', '2', '3', '4', '5', '6', '7':
					# 第一位是 nc 本身, 其后最多再取 2 位
					var oct_val = int(next_ch)
					var oct_cnt = 1
					while oct_cnt < 3 and i + 1 + oct_cnt < n and s[i + 1 + oct_cnt] >= '0' and s[i + 1 + oct_cnt] <= '7':
						oct_val = oct_val * 8 + int(s[i + 1 + oct_cnt])
						oct_cnt += 1
					if not _check_cp(oct_val):
						return result
	...
	## 从位置 pos 取至多 max_len 个十六进制数字 [br]
	## [returns] [数值, 实际取得的位数]
	func _take_hex(s: String, pos: int, max_len: int) -> Array:
		var val = 0
		var cnt = 0
		while cnt < max_len and pos + cnt < s.length():
			var c = s[pos + cnt]
			var v = -1
			if c >= '0' and c <= '9':
				v = int(c)
	...
	func _check_cp(cp: int) -> bool:
		if cp == 0:
			report.error("SyntaxError: NUL character in string literal is not supported")
			return false
		return true
	...
	func _unescape_bytes(s: String, is_raw: bool) -> Array[int]:
		var out: Array[int] = []
		var n = s.length()
		if is_raw:
			var ri = 0
			while ri < n:
				var rc = s.unicode_at(ri)
				if rc > 255:
		...
		while i < n:
			...
			match nc:
				...
				'0', '1', '2', '3', '4', '5', '6', '7':
					...
					i += 1 + oct_cnt
				_:
					# 未识别转义 (含 \u \U \N): 原样保留反斜杠与该字符 (CPython 语义)
					out.append(92)
					out.append(nc.unicode_at(0))
					i += 2
		return out
	...
	func _take_named_escape(s: String, pos: int):
		if pos >= s.length() or s[pos] != '{':
			return null
		var close = s.find('}', pos + 1)
		if close == -1:
			return null
		var name = s.substr(pos + 1, close - pos - 1)
		if not _NAMED_ESCAPES.has(name):
			return null
		return [_NAMED_ESCAPES[name], close + 1]
...
class TryStmt extends Stmt:
	...
	## else 分支语句列表 (可为空数组), try 体正常结束时执行
	var else_body: Array
	...
	func _init(try_b, exc_c, fin_b, else_b = []):
		try_body = try_b
...
class DSLObject:
	...
	func magic_getitem(_args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		# 用户类 __getitem__ 协议 (与 __len__ 同一桥接模式)
		if klass != null:
			var method = klass._lookup_method("__getitem__")
			if method != null:
				return klass._invoke_func(method, [self, _args[1]] as Array[DSLObject], {} as Dictionary[String, DSLObject])
	...
	func magic_setitem(_args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		# 用户类 __setitem__ 协议
		if klass != null:
			var method = klass._lookup_method("__setitem__")
			if method != null:
				klass._invoke_func(method, [self, _args[1], _args[2]] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				return DSLNone.new()
	...
	func _dsl_delitem(_index: DSLObject):
		# 用户类 __delitem__ 协议
		if klass != null:
			var method = klass._lookup_method("__delitem__")
			if method != null:
				klass._invoke_func(method, [self, _index] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				return
	...
	func _dsl_setitem(_index: DSLObject, _value: DSLObject):
		...
		if klass != null:
			var method = klass._lookup_method("__setitem__")
			if method != null:
				klass._invoke_func(method, [self, _index, _value] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				return
		last_error = "TypeError: '%s' object does not support item assignment" % [_type_name()]
		return null
...
class DSLNone extends DSLObject:
	...
	## None 的相等判定按值语义 (不同 DSLNone 实例也相等)
	func magic_eq(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLBool:
		if len(args) == 2:
			return DSLBool.new(_dsl_eq(args[1]))
		return DSLBool.new(true)
...
class DSLInteger extends DSLObject:
	...
	## Python 整数取模: 结果符号跟随除数 (Godot 的 % 符号跟随被除数, 需修正)
	static func _py_mod(a: int, b: int) -> int:
		return a - b * _py_floordiv(a, b)
	...
	func _dsl_getattribute(name: String) -> DSLObject:
		...
		# 数值字面量实例未挂 klass, 实例方法经 int 类注册表解析
		var cls = klass if klass != null else DSLInteger._type_class
		if cls != null:
	...
	func builtin_to_bytes(args: Array[DSLObject], kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if byteorder == "big":
			...
			last_error = "ValueError: byteorder must be either 'little' or 'big'"
			return null
	...
	func builtin_hex(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		while m > 0:
			s = digits[m & 0xF] + s
			m = m >> 4
		return DSLString.new(sign + "0x" + s)

## DSL 浮点数类型, 对应 Python float
class DSLFloat extends DSLObject:
	## float 类引用 (register_builtins 注入): 数值字面量实例未挂 klass, 方法查找经它解析
	static var _type_class: DSLClass = null
	## 底层的浮点值
	var value: float
	...
	func magic_mod(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if other is DSLInteger or other is DSLFloat:
			...
			if v == 0:
				self_obj.last_error = "ZeroDivisionError: float modulo"
				return null
			# CPython 的 float % 符号跟随除数 (fmod 是 C 语义, 符号跟随被除数)
			return DSLFloat.new(self_obj.value - v * floor(self_obj.value / v))
		self_obj._arithmetic_type_error("%", other)
		return null
	...
	func _dsl_getattribute(name: String) -> DSLObject:
		...
		# 数值字面量实例未挂 klass, 实例方法经 float 类注册表解析
		var cls = klass if klass != null else DSLFloat._type_class
		if cls != null:
			var m = cls._dsl_getattribute(name)
			if cls.last_error != "":
				cls.last_error = ""
	...
	func builtin_is_integer(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var v = args[0].value
		return DSLBool.new(v == floor(v) and not is_nan(v))

	func builtin_as_integer_ratio(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var v = args[0].value
		if is_inf(v) or is_nan(v):
			last_error = "OverflowError: cannot convert %s to integer ratio" % ("Infinity" if is_inf(v) else "NaN")
			return null
		var neg = v < 0.0
		var m = abs(v)
		var e = 0
		...
		var mant = int(m * 9007199254740992.0)
		var exp = e - 53
		while mant != 0 and mant % 2 == 0:
			mant /= 2
			exp += 1
		var num = mant if not neg else -mant
		var den = 1
		while exp < 0:
			den *= 2
			exp += 1
...
class DSLString extends DSLObject:
	...
	func _percent_format(fmt: String, values: Array[DSLObject]) -> String:
		...
		while i < fmt.length():
			...
			if named == null:
				vi += 1
			var one = _format_one(val, conv, width, precision, flags)
			if last_error != "":
				return out
			out += one
		return out
	...
	func _add_thousands(s: String) -> String:
		return _add_grouped(s, ",", 3)

	## 通用数字分组: 从右往左, 仅作用于整数部分 (符号与小数部分不动) [br]
	## [param sep] 分隔符 ("," 或 "_") [br]
	## [param size] 分组位数 (3 或 4)
	func _add_grouped(s: String, sep: String, size: int) -> String:
	...
	func _format_spec_value(value: DSLObject, spec: String, pre: String = "") -> String:
		...
		while i < spec.length() and spec[i].is_valid_int():
			...
			i += 1
		# [,] 或 [_] 分组选项 (CPython: 二者互斥)
		if i < spec.length() and (spec[i] == "," or spec[i] == "_"):
			group_sep = spec[i]
			i += 1
			if i < spec.length() and (spec[i] == "," or spec[i] == "_"):
				last_error = "ValueError: Cannot specify both ',' and '_'."
				return ""
		# [.precision]
		if i < spec.length() and spec[i] == ".":
			i += 1
		...
		if pre != "":
			...
			s = _format_spec_base(value, type_c, precision, group_sep)
		# 符号前缀
	...
	func _format_spec_base(value: DSLObject, type_c: String, precision: int, group_sep: String) -> String:
		...
		if type_c in ["x", "X", "o", "b"]:
			# CPython: ',' 不能与 x/X/o/b 同用, '_' 按 4 位分组
			if group_sep == ",":
	...
	func builtin_format_map(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var mapping = DSLObject._unwrap_dsl(args[1])
		var kwargs: Dictionary[String, DSLObject] = {}
		if mapping is DSLDict:
			for k in mapping.dict.keys():
				kwargs[mapping._wrap_key(k).value] = mapping.dict[k]
		else:
			last_error = "TypeError: format_map() argument must be a mapping"
			return null
		return builtin_format([args[0]] as Array[DSLObject], kwargs)
	...
	func _ensure_str_descriptors():
		...
		_str_descriptors["encode"] = DSLMethodDescriptor.new("encode", Callable(proto, "builtin_encode"))
		_str_descriptors["format_map"] = DSLMethodDescriptor.new("format_map", Callable(proto, "builtin_format_map"))
...
class DSLList extends DSLObject:
	...
	## 找到首个不等元素按其大小关系定序, 一方是另一方前缀时短者更小 [br]
	...
	static func _seq_lex_compare(a_items: Array[DSLObject], b_items: Array[DSLObject], err_obj: DSLObject, op: String) -> int:
		...
		for i in range(n):
			...
			if av._dsl_eq(bv):
				continue
			var cmp: DSLObject = null
			if interp != null:
				av.last_error = ""
				cmp = interp._sort_compare(av, bv, "__lt__", "__gt__", "magic_lt")
				...
				var saved = av.last_error
				av.last_error = ""
				cmp = av.magic_lt([av, bv] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				if av.last_error == "" and cmp is DSLBool:
					av.last_error = saved
					return -1 if cmp.value else 1
				av.last_error = "TypeError: '%s' not supported between instances of '%s' and '%s'" % [op, av._type_name(), bv._type_name()]
				return -2
			if cmp is DSLBool:
				return -1 if cmp.value else 1
			av.last_error = "TypeError: '%s' not supported between instances of '%s' and '%s'" % [op, av._type_name(), bv._type_name()]
	...
	## 字典序比较: list 只与 list 比较, 与 tuple 互比报 TypeError (CPython 语义)
	func magic_lt(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLBool:
		var self_obj = args[0]
		var other = args[1]
		other = DSLObject._unwrap_dsl(other)
		if other is DSLList:
			var c = _seq_lex_compare(self_obj.items, other.items, self_obj, "<")
			if c == -2:
				return DSLBool.new(false)
	...
	## 相等判定: 列表间逐元素递归 _dsl_eq, 嵌套容器比较由此生效
	func _dsl_eq(other: DSLObject) -> bool:
		var rhs = other
		if rhs != null:
			rhs = DSLObject._unwrap_dsl(rhs)
		if rhs is DSLList:
			...
			for i in range(items.size()):
				if not items[i]._dsl_eq(rhs.items[i]):
					return false
			return true
		return false
	...
	func _slice_assign(sl: DSLSlice, value: DSLObject):
		var res = DSLList._list_slice_indices(sl, items.size(), self)
		if res == null:
			return
		var start_i = res[0]
		var stop_i = res[1]
		var step_i = res[2]
		# 右侧必须可迭代, 先完整收集再修改 (挂起重放时原列表不被破坏)
		var new_vals: Array[DSLObject] = []
		var src = DSLObject._unwrap_dsl(value)
		if src is DSLList or src is DSLTuple:
			new_vals = src.items.duplicate()
		else:
			var it = src._dsl_iter()
			if it == null:
				last_error = "TypeError: must assign iterable to extended slice"
				return
			while it.has_next():
				new_vals.append(it.next())
				if it.suspended:
					return
		if step_i == 1:
			var head = items.slice(0, start_i)
			var tail = items.slice(stop_i)
			items.clear()
			items.append_array(head)
			items.append_array(new_vals)
			items.append_array(tail)
			return
		# 扩展切片 (step != 1): 只能等长替换
		var span = DSLList._slice_span(start_i, stop_i, step_i)
		if span != new_vals.size():
			last_error = "ValueError: attempt to assign sequence of size %d to extended slice of size %d" % [new_vals.size(), span]
			return
		var idx = start_i
		var k = 0
		while (step_i > 0 and idx < stop_i) or (step_i < 0 and idx > stop_i):
			items[idx] = new_vals[k]
			idx += step_i
			k += 1
	...
	func _dsl_delitem(index: DSLObject):
		...
		if index is DSLInteger:
			...
			return
		if index is DSLSlice:
			var res = DSLList._list_slice_indices(index, raw.items.size(), raw)
			if res == null:
				return
			var start_i = res[0]
			var stop_i = res[1]
			var step_i = res[2]
			if step_i == 1:
				var head = raw.items.slice(0, start_i)
				var tail = raw.items.slice(stop_i)
				raw.items.clear()
				raw.items.append_array(head)
				raw.items.append_array(tail)
				return
			# 扩展切片删除: 收集选中的下标, 从后往前删
			var idxs: Array[int] = []
			var idx = start_i
			while (step_i > 0 and idx < stop_i) or (step_i < 0 and idx > stop_i):
				idxs.append(idx)
			...
			idxs.reverse()
			for ix in idxs:
				raw.items.remove_at(ix)
			return
		# 未支持下标类型: 明确报错
		last_error = "TypeError: '%s' object does not support item deletion" % _type_name()

	## 统计切片选中的元素个数 (range(start, stop, step) 的长度)
	static func _slice_span(start_i: int, stop_i: int, step_i: int) -> int:
		if step_i > 0:
			if stop_i <= start_i:
				return 0
			return ceili(float(stop_i - start_i) / float(step_i))
		if stop_i >= start_i:
			return 0
		return ceili(float(start_i - stop_i) / float(-step_i))

	## 规范化切片下标为 (start, stop, step), CPython slice.indices 语义 [br]
	## 缺省分量按 step 方向补默认值, null 与 None 都视为缺省, bool 按 0/1 参与 [br]
	## [returns] 三元组数组, 步长为 0 或下标非整数时设置 err_obj.last_error 并返回 null
	static func _list_slice_indices(sl: DSLSlice, n: int, err_obj: DSLObject):
		...
		if sl.stop != null and not sl.stop is DSLNone:
			...
			if pstop < 0:
				pstop += n
			if pstep > 0:
				pstop = clampi(pstop, 0, n)
			else:
				pstop = clampi(pstop, -1, n - 1)
	...
	func builtin_sort(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if _kwargs.has("key"):
			...
			if reverse_val:
				...
				raw.items.sort_custom(Callable(self, "_cmp_items"))
		if _cmp_error != "":
			# 比较不可用: 转为 TypeError (由 _dispatch_call 检查接收者 last_error 抛出)
			raw.last_error = _cmp_error
			_cmp_error = ""
			return null
		return DSLNone.new()
	...
	## 比较器上次失败留下的错误文案 (sort_custom 回调内无法直接抛异常, 由调用方收尾检查)
	static var _cmp_error: String = ""

	## 排序比较器, 调用 a.magic_lt(b) 进行元素比较 [br]
	## 比较不可用时记录 _cmp_error, 使排序从「静默原序」变为「明确报错」 [br]
	## [param b] 右侧元素 [br]
	## [returns] a < b 则 true
	static func _cmp_items(a: DSLObject, b: DSLObject) -> bool:
		var interp = Interpreter.active
		var bridged: DSLObject = null
		if interp != null:
			bridged = interp._sort_compare(a, b, "__lt__", "__gt__", "magic_lt")
		else:
			var saved = a.last_error
			a.last_error = ""
			bridged = a.magic_lt([a, b] as Array[DSLObject], {} as Dictionary[String, DSLObject])
			if a.last_error != "":
				bridged = null
			a.last_error = saved
		if bridged is DSLBool:
			return bridged.value
		if interp != null and interp._suspended:
			return false
		if interp != null and interp.report.has_error:
			# 用户比较方法体内抛出的真实异常: 保留错误状态, 由调用收尾或语句级检查向上传播
			return false
		_cmp_error = "TypeError: '<' not supported between instances of '%s' and '%s'" % [a._type_name(), b._type_name()]
		return false
...
class DSLTuple extends DSLObject:
	...
	## 字典序比较: tuple 只与 tuple 比较, 与 list 互比报 TypeError (CPython 语义)
	func magic_lt(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLBool:
		var self_obj = args[0]
		var other = args[1]
		other = DSLObject._unwrap_dsl(other)
		if other is DSLTuple:
			var c = DSLList._seq_lex_compare(self_obj.items, other.items, self_obj, "<")
			if c == -2:
				return DSLBool.new(false)
			return DSLBool.new(c < 0)
		self_obj._comparison_type_error("<", other)
	...
	## 相等判定: 元组间逐元素递归 _dsl_eq, 嵌套容器比较由此生效
	func _dsl_eq(other: DSLObject) -> bool:
		var rhs = other
		if rhs != null:
			rhs = DSLObject._unwrap_dsl(rhs)
...
class DSLDict extends DSLObject:
	...
	## 相等判定: 键集合与对应值递归 _dsl_eq, 嵌套容器比较由此生效 [br]
	## 内部 dict 的键已由 _key_to_variant 规范化, 可直接比对
	func _dsl_eq(other: DSLObject) -> bool:
		var rhs = other
		if rhs != null:
			rhs = DSLObject._unwrap_dsl(rhs)
		if rhs is DSLDict:
			if dict.size() != rhs.dict.size():
				return false
			for key in dict.keys():
				if not rhs.dict.has(key):
					return false
				if not dict[key]._dsl_eq(rhs.dict[key]):
					return false
			return true
		return false
	...
	func _key_to_variant(key: DSLObject) -> Variant:
		...
		# 字符串键加 "s:" 前缀: 与 None 哨兵 "n" 及其它类型编码区分 (对齐 DSLSet._set_key)
		if key is DSLString:
			return "s:" + key.value
		# None 可作字典键 (编码与 DSLSet._set_key 的 "n" 约定一致)
		if key is DSLNone:
			return "n"
...
class DSLBytes extends DSLObject:
	...
	## 属性访问: 字面量创建的实例未挂 klass, 统一经 bytes 类解析方法
	func _dsl_getattribute(name: String) -> DSLObject:
		var cls = klass if klass != null else DSLBytes._type_class
		if cls != null:
			var m = cls._dsl_getattribute(name)
			if cls.last_error != "":
				cls.last_error = ""
			if m != null and not (m is DSLNone):
				if m.has_method("__get__"):
					return m.__get__(self, cls)
				return m
		last_error = "AttributeError: 'bytes' object has no attribute '%s'" % name
		return DSLNone.new()
	...
	func _bytes_arg_to_data(obj: DSLObject) -> Array[int]:
		...
		if raw is DSLList or raw is DSLTuple:
			for it in raw.items:
				if it is DSLInteger and it.value >= 0 and it.value <= 255:
					out.append(it.value)
			return out
		return out

	## 在 data 中查找子序列, 返回首个下标 (找不到返回 -1)
	func _bytes_find(hay: Array[int], needle: Array[int], start: int, end: int) -> int:
		if needle.is_empty():
			return maxi(start, 0)
		var m = needle.size()
		var i = maxi(start, 0)
	...
	func builtin_hex(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		var sep = ""
		if _kwargs.has("sep"):
			sep = _kwargs["sep"]._dsl_str()
		elif args.size() >= 2 and args[1] is DSLString:
			sep = args[1].value
		var s = ""
	...
	func builtin_title(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		for b in raw.data:
			var is_letter = (b >= 97 and b <= 122) or (b >= 65 and b <= 90)
			if is_letter and not prev_letter and b >= 97 and b <= 122:
				b -= 32
			elif is_letter and prev_letter and b >= 65 and b <= 90:
				b += 32
			out.append(b)
	...
	func _strip_char_set(args: Array[DSLObject]) -> Dictionary:
		var chars = {}
		if args.size() >= 2 and args[1] is DSLBytes:
			for b in args[1].data:
				chars[b] = true
		else:
	...
	func _is_byte_space(b: int) -> bool:
		return b == 32 or b == 9 or b == 10 or b == 13 or b == 11 or b == 12

	func builtin_strip(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var chars = _strip_char_set(args)
		var lo = 0
		var hi = raw.data.size()
		while lo < hi and chars.has(raw.data[lo]):
			lo += 1
	...
	func builtin_split(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var sep_data: Array[int] = []
		var has_sep = false
		if args.size() >= 2 and args[1] is DSLBytes:
			sep_data = args[1].data
			has_sep = true
		var maxsplit = -1
		if args.size() >= 3 and args[2] is DSLInteger:
			maxsplit = args[2].value
		var parts: Array[DSLObject] = []
		var cur: Array[int] = []
		var i = 0
		var n = raw.data.size()
		if has_sep:
			var m = sep_data.size()
			while i < n:
				if maxsplit >= 0 and parts.size() >= maxsplit:
					break
	...
	func builtin_replace(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var old_data = _bytes_arg_to_data(args[1])
		var new_data = _bytes_arg_to_data(args[2])
		var count = -1
		if args.size() >= 4 and args[3] is DSLInteger:
			count = args[3].value
		var out: Array[int] = []
		...
		while i < n:
			if count >= 0 and done >= count:
				break
			var pos = _bytes_find(raw.data, old_data, i, n)
			if pos < 0:
				break
			for j in range(i, pos):
				out.append(raw.data[j])
			out.append_array(new_data)
			i = pos + old_data.size()
			done += 1
		for j in range(i, n):
			out.append(raw.data[j])
	...
	func builtin_index(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if pos is DSLInteger and pos.value < 0:
			last_error = "ValueError: substring not found"
			return null
		return pos
	...
	func builtin_count(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		var total = 0
		var i = 0
		while i <= raw.data.size() - sub.size():
			var pos = _bytes_find(raw.data, sub, i, raw.data.size())
			if pos < 0:
				break
			total += 1
	...
	func builtin_startswith(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var sub = _bytes_arg_to_data(args[1])
		return DSLBool.new(raw.data.size() >= sub.size() and _bytes_find(raw.data, sub, 0, sub.size()) == 0)

	func builtin_endswith(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var sub = _bytes_arg_to_data(args[1])
		var off = raw.data.size() - sub.size()
		return DSLBool.new(off >= 0 and _bytes_find(raw.data, sub, off, raw.data.size()) == off)

	func builtin_join(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var raw = DSLObject._unwrap_dsl(args[0])
		var it = args[1]._dsl_iter()
		if it == null:
			last_error = "TypeError: can only join an iterable"
			return null
		var out: Array[int] = []
		var first = true
		while it.has_next():
			...
			if it.suspended:
				break
			var seg = _bytes_arg_to_data(item)
			if not first:
...
class DSLSet extends DSLObject:
	...
	## 集合运算实参规范化: set 原样返回, 其余可迭代消费为集合 (CPython 集合运算接受任意可迭代)
	func _set_arg_to_set(obj: DSLObject) -> DSLSet:
		var raw = DSLObject._unwrap_dsl(obj)
		if raw is DSLSet:
			return raw
		if raw == null or raw._wrapped != null and false:
			return null
		var out = DSLSet.new()
	...
	func builtin_intersection_update(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if other == null:
			...
			return null
		var keep = []
		for k in self_obj.items.keys():
			if other._contains_key(self_obj.items[k]):
				keep.append(k)
		var new_items = {}
		for k in keep:
			new_items[k] = self_obj.items[k]
		self_obj.items = new_items
		return DSLNone.new()

	func builtin_difference_update(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var self_obj = args[0]
		var other = _set_arg_to_set(args[1])
		if other == null:
			args[0].last_error = "TypeError: '%s' object is not iterable" % args[1]._type_name()
		...
		for k in self_obj.items.keys():
			if other._contains_key(self_obj.items[k]):
				drop.append(k)
		for k in drop:
			self_obj.items.erase(k)
		return DSLNone.new()

	func builtin_symmetric_difference_update(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		var self_obj = args[0]
		var other = _set_arg_to_set(args[1])
		if other == null:
			args[0].last_error = "TypeError: '%s' object is not iterable" % args[1]._type_name()
		...
		for k in self_obj.items.keys():
			if other._contains_key(self_obj.items[k]):
				drop.append(k)
		for k2 in other.items.keys():
			if not self_obj._contains_key(other.items[k2]):
				add.append(other.items[k2])
		for k in drop:
			self_obj.items.erase(k)
		for v in add:
			self_obj._dsl_add(v)
...
class DSLDefaultDict extends DSLObject:
	...
	func builtin_most_common(args: Array, _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		for k in self_obj.inner.dict.keys():
			...
			var obj_key: DSLObject = self_obj.inner._wrap_key(k)
...
class DSLSeqIterator extends DSLObject:
	...
	var target: DSLObject = null
	## 迭代器类型名 (list_iterator / tuple_iterator / str_iterator / str_ascii_iterator / range_iterator / dict_keyiterator / set_iterator)
	var iter_type: String = "list_iterator"
	## 内部驱动器 (首次消费时创建, 复用以共享消费进度)
	var driver: DSLIterator = null

	## 构造一等迭代器 [br]
	## [param t] 被迭代的容器 [br]
	## [param tname] 迭代器类型名
	func _init(t: DSLObject, tname: String):
		super._init()
		target = t
		iter_type = tname
		# 立即创建驱动器: 迭代器的起点状态 (如字典键快照) 必须在 iter() 调用时定格,
		# 懒加载会使首次消费前的容器修改被误认为合法初始状态
		_ensure_driver()

	func _type_name() -> String:
		return iter_type

	## 获取内部驱动器 (惰性创建, 创建后共享进度)
	func _ensure_driver() -> DSLIterator:
		if driver == null:
			driver = target._dsl_iter()
		return driver
...
class Parser:
	...
	func try_statement():
		...
		return TryStmt.new(try_body, except_clauses, finally_body, else_body)
	...
	## 下标可为普通表达式或切片 (a[1:3] = v 与 del a[1:3]) [br]
		...
		while true:
			if check(TokenType.LBRACKET):
				...
				if match_types([TokenType.COLON]):
					...
					var step_e = null
					if not check(TokenType.RBRACKET) and not check(TokenType.COLON):
						stop_e = simple_expression()
						if stop_e == null:
							return null
					if match_types([TokenType.COLON]):
						if not check(TokenType.RBRACKET):
							step_e = simple_expression()
							if step_e == null:
								return null
...
class Interpreter:
	...
	## 当前活跃的解释器引用 (单解释器模型): 供不持有解释器参数的底层对象
	## (如迭代器) 在错误发生时上报异常
	static var active: Interpreter = null
	...
	## sorted 排序比较失败留下的错误文案 (sort_custom 回调内无法直接抛异常, 收尾时检查)
	var _compare_error: String = ""
	...
	func register_builtins():
		...
		# dict 视图类型 (dict_keys / dict_values / dict_items): 仅注册进内置类型表
		# (供 type() 返回), 不进入全局命名空间 (CPython 中这些类型名也不是内建名),
		# 其实例由 dict.keys() / dict.values() / dict.items() 直接构造
		var dict_keys_class = DSLClass.new("dict_keys", obj_class, {}, self)
		dict_keys_class.klass = type_class
		_builtin_type_classes["dict_keys"] = dict_keys_class
		var dict_values_class = DSLClass.new("dict_values", obj_class, {}, self)
		dict_values_class.klass = type_class
		_builtin_type_classes["dict_values"] = dict_values_class
		...
		globals.define("format", _make_builtin("format", Callable(self, "builtin_format_value")))
		globals.define("dir", _make_builtin("dir", Callable(self, "builtin_dir")))
		...
		var bytes_methods = {}
		bytes_methods["__new__"] = _make_builtin("__new__", Callable(self, "api_bytes_new"))
		var bytes_cls = DSLClass.new("bytes", obj_class, bytes_methods, self)
		...
		globals.define("hasattr", _make_builtin("hasattr", Callable(self, "builtin_hasattr")))
	...
	func execute(stmt) -> ExecResult:
			...
			for target in stmt.targets:
				if target is Variable:
					...
					if target.index is SliceExpr:
						index = _eval_slice_value(target.index)
					else:
						index = evaluate(target.index)
					if _suspended:
						_expr_evaluated = false
						return ExecResult.SUSPENDED
					if index == null:
		...
		if stmt is TryStmt:
			...
			if stage == "except":
				...
				if res == ExecResult.SUSPENDED:
					return res
				# try 体正常结束才执行 else (return/break/continue 跳出时跳过)
				if res == ExecResult.NORMAL and stmt.else_body.size() > 0:
					if _exec_stack.size() > 0:
						_exec_stack.back().resume_info = {"try_stage": "else"}
					var else_res = exec_block(stmt.else_body, environment)
					if else_res == ExecResult.SUSPENDED:
						return else_res
					res = else_res
	...
	## 将切片表达式求值为 DSLSlice (SetItem / DelStmt 目标共用) [br]
	## [param sl] SliceExpr 节点 [br]
	## [returns] DSLSlice 对象, 分量求值失败时返回 null
	func _eval_slice_value(sl: SliceExpr) -> DSLSlice:
		var start_val = null
		if sl.start != null:
			start_val = evaluate(sl.start)
			if start_val == null:
				return null
		var stop_val = null
		if sl.stop != null:
			stop_val = evaluate(sl.stop)
			if stop_val == null:
				return null
		var step_val = null
		if sl.step != null:
			step_val = evaluate(sl.step)
			if step_val == null:
				return null
		return DSLSlice.new(start_val, stop_val, step_val)
	...
	func _drain_eager_comp(expr, env):
		...
		_comp_drain_stack.pop_back()
		# 生成器迭代器把迭代期间的错误 (如字典迭代中修改) 视为耗尽:
		# 此处甄别「真耗尽」与「出错终止」, 出错时不得返回已累积的部分结果
		if report.has_error:
			return null
	...
	func _format_value(value: DSLObject, conv: String, fmt: String) -> String:
		...
		while i < fmt.length() and fmt[i].is_valid_int():
			width = width * 10 + int(fmt[i])
			i += 1
		# 分组选项 (, 或 _, CPython: 二者互斥)
		if i < fmt.length() and (fmt[i] == "," or fmt[i] == "_"):
			group_sep = fmt[i]
			i += 1
			if i < fmt.length() and (fmt[i] == "," or fmt[i] == "_"):
				raise_exception("ValueError", "Cannot specify both ',' and '_.'")
				return ""
		# 精度
		if i < fmt.length() and fmt[i] == ".":
			i += 1
		...
		var s = _format_with_type(value, type_c, precision, group_sep)
		# 符号前缀
		if is_numeric and sign != "" and not s.begins_with("-"):
			if sign == "+":
				s = "+" + s
	...
	## 通用数字分组: 从右往左, 仅作用于整数部分 (符号与小数部分不动)
	func _add_grouped(s: String, sep: String, size: int) -> String:
		var neg = s.begins_with("-")
		if neg:
			s = s.substr(1)
	...
	func _dispatch_call(callee, pos_args: Array[DSLObject], kw_dict: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if _suspended:
			...
			# 否则重放被跳过, 语句得到半成品结果; 仅当挂起就是本调用自身
			# (如顶层 sleep 语句, 副作用已完成) 时返回 None 使语句被跳过
	...
	func _inject_builtin_methods(class_obj: DSLClass, cls_name: String):
		match cls_name:
			"str":
				...
				class_obj.methods["encode"] = DSLMethodDescriptor.new("encode", Callable(proto, "builtin_encode"))
				class_obj.methods["format_map"] = DSLMethodDescriptor.new("format_map", Callable(proto, "builtin_format_map"))
			...
			"bytes":
				...
				class_obj.methods["decode"] = DSLMethodDescriptor.new("decode", Callable(bytes_proto, "builtin_decode"))
				class_obj.methods["hex"] = DSLMethodDescriptor.new("hex", Callable(bytes_proto, "builtin_hex"))
				class_obj.methods["upper"] = DSLMethodDescriptor.new("upper", Callable(bytes_proto, "builtin_upper"))
				class_obj.methods["lower"] = DSLMethodDescriptor.new("lower", Callable(bytes_proto, "builtin_lower"))
				class_obj.methods["title"] = DSLMethodDescriptor.new("title", Callable(bytes_proto, "builtin_title"))
				class_obj.methods["strip"] = DSLMethodDescriptor.new("strip", Callable(bytes_proto, "builtin_strip"))
				class_obj.methods["lstrip"] = DSLMethodDescriptor.new("lstrip", Callable(bytes_proto, "builtin_lstrip"))
				class_obj.methods["rstrip"] = DSLMethodDescriptor.new("rstrip", Callable(bytes_proto, "builtin_rstrip"))
				class_obj.methods["split"] = DSLMethodDescriptor.new("split", Callable(bytes_proto, "builtin_split"))
				class_obj.methods["replace"] = DSLMethodDescriptor.new("replace", Callable(bytes_proto, "builtin_replace"))
				class_obj.methods["find"] = DSLMethodDescriptor.new("find", Callable(bytes_proto, "builtin_find"))
				class_obj.methods["index"] = DSLMethodDescriptor.new("index", Callable(bytes_proto, "builtin_index"))
				class_obj.methods["count"] = DSLMethodDescriptor.new("count", Callable(bytes_proto, "builtin_count"))
				class_obj.methods["startswith"] = DSLMethodDescriptor.new("startswith", Callable(bytes_proto, "builtin_startswith"))
				class_obj.methods["endswith"] = DSLMethodDescriptor.new("endswith", Callable(bytes_proto, "builtin_endswith"))
				class_obj.methods["join"] = DSLMethodDescriptor.new("join", Callable(bytes_proto, "builtin_join"))
			...
			"set":
				...
				class_obj.methods["update"] = DSLMethodDescriptor.new("update", Callable(proto, "builtin_update"))
				class_obj.methods["intersection_update"] = DSLMethodDescriptor.new("intersection_update", Callable(proto, "builtin_intersection_update"))
				class_obj.methods["difference_update"] = DSLMethodDescriptor.new("difference_update", Callable(proto, "builtin_difference_update"))
				class_obj.methods["symmetric_difference_update"] = DSLMethodDescriptor.new("symmetric_difference_update", Callable(proto, "builtin_symmetric_difference_update"))
			"frozenset":
	...
	func _minmax_impl(args: Array[DSLObject], kwargs: Dictionary[String, DSLObject], is_min: bool) -> DSLObject:
		var fname = "min" if is_min else "max"
		var opname = "<" if is_min else ">"
		var key_func = null
		if kwargs.has("key"):
			key_func = kwargs["key"]
		...
		if args.size() == 1:
			...
			candidates = args
		# 逐候选求值 key (每项一次), 用 key 值比较, 返回原对象
		var best = candidates[0]
		var best_key = best
		if key_func != null:
			best_key = key_func.magic_call([best] as Array[DSLObject], {} as Dictionary[String, DSLObject])
			if best_key == null:
				return null
		for i in range(1, candidates.size()):
			...
			var cand_key = cand
			if key_func != null:
				cand_key = key_func.magic_call([cand] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				if cand_key == null:
					return null
			# _sort_compare 返回的 DSLBool 已在其内部甄别过比较失败, 此处直接信任;
			# 其运行期间在操作数上留下的 last_error 残留由本处清理
			var cmp = _sort_compare(cand_key, best_key, "__lt__" if is_min else "__gt__", "__gt__" if is_min else "__lt__", "magic_lt" if is_min else "magic_gt")
			cand_key.last_error = ""
			if _suspended:
				return null
			if cmp is DSLBool:
				...
				continue
			if report.has_error:
				# 用户比较方法体内抛出的真实异常: 保留错误状态, 由语句级检查向上传播
				return null
			raise_exception("TypeError", "'%s' not supported between instances of '%s' and '%s'" % [opname, cand_key._type_name(), best_key._type_name()])
			return null
		return best
	...
	## 检查 sort_custom 期间比较器是否记录了失败, 是则转为 TypeError
	func _check_compare_error() -> bool:
		if _compare_error == "":
			return false
	...
	## 排序与 min/max 的元素比较统一入口, 与二元运算符同一分派语义: [br]
	## 先调 x 的用户比较方法, 不可用时试 y 的反射比较方法, 再不可用回退内置比较 [br]
	## [param x] 主操作数 [br]
	## [param y] 次操作数 (反射比较的接收者) [br]
	## [param dunder] 主比较方法名 (如 "__lt__") [br]
	## [param reflected_dunder] 反射比较方法名 (如 "__gt__") [br]
	## [param magic] 内置回退比较的 GDScript 方法名 (magic_lt / magic_gt) [br]
	## [returns] DSLBool; 不可比较或用户方法体内抛异常返回 null, 挂起返回 null 并置挂起标志
	func _sort_compare(x: DSLObject, y: DSLObject, dunder: String, reflected_dunder: String, magic: String) -> DSLObject:
		var had_error = report.has_error
		var cmp = _call_magic_or_fallback(x, dunder, [y] as Array[DSLObject], func() -> DSLObject:
			return _invoke_builtin_compare(x, y, magic))
		if _suspended:
			return null
		if cmp is DSLBool and x.last_error == "":
			return cmp
		if report.has_error and not had_error:
			return null
		# 内置回退失败会在操作数上留下错误文案残留, 反射尝试前必须清除,
		# 否则用户比较方法体内的属性访问会把它误判为本次求值的错误
		x.last_error = ""
		if reflected_dunder != "":
			cmp = _call_magic_or_fallback(y, reflected_dunder, [x] as Array[DSLObject], func() -> DSLObject:
				return null)
			if _suspended:
				return null
			if cmp is DSLBool and y.last_error == "":
				return cmp
			y.last_error = ""
			if report.has_error and not had_error:
				return null
	...
	## 按方法名调用内置比较 (fallback 需动态分派 magic_lt / magic_gt)
	func _invoke_builtin_compare(x: DSLObject, y: DSLObject, magic: String) -> DSLObject:
		if magic == "magic_gt":
			return x.magic_gt([x, y] as Array[DSLObject], {} as Dictionary[String, DSLObject])
		return x.magic_lt([x, y] as Array[DSLObject], {} as Dictionary[String, DSLObject])
	...
	## 降序比较函数, 用于 sorted [br]
	## 按 CPython 语义比较 b < a (仍走 __lt__ 与反射), 而非调用 __gt
	func _compare_desc(a: DSLObject, b: DSLObject) -> bool:
		var cmp = _sort_compare(b, a, "__lt__", "__gt__", "magic_lt")
		if cmp is DSLBool:
			return cmp.value
		if _suspended:
			return false
	...
	## hasattr(obj, name) - 判断对象是否有给定属性 [br]
	## 按 try-getattr 语义实现: 属性查找失败且错误为 AttributeError 时返回 False, [br]
	## 其余错误 (如 __getattr__ 内抛出的异常) 原样传播, 不吞掉
	func builtin_hasattr(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		if args.size() != 2:
			raise_exception("TypeError", "hasattr expected 2 arguments, got %d" % args.size())
			return null
		var obj = args[0]
		var name_obj = args[1]
		var name = name_obj.value if name_obj is DSLString else name_obj._dsl_str()
	...
	func builtin_float(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLFloat:
		...
		# 用户类 __float__ 协议
		if arg.klass != null:
			var method = arg.klass._lookup_method("__float__")
			if method != null:
				var res = arg.klass._invoke_func(method, [arg] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				if res == null:
					return null
				if res is DSLFloat:
					return res
				if res is DSLInteger:
					return DSLFloat.new(float(res.value))
				raise_exception("TypeError", "__float__ returned non-float (type %s)" % res._type_name())
				return null
	...
	func builtin_iter(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if obj is DSLRepeat or obj is DSLCount or obj is DSLCycle:
			return DSLSeqIterator.new(obj, obj._type_name())
		# 序列类型返回一等迭代器对象: 持原容器引用 (活动视图)
		if obj is DSLList:
			return DSLSeqIterator.new(obj, "range_iterator" if obj.is_range else "list_iterator")
		if obj is DSLTuple:
			return DSLSeqIterator.new(obj, "tuple_iterator")
		if obj is DSLString:
			var all_ascii = true
			for ci in range(obj.value.length()):
				if obj.value.unicode_at(ci) > 127:
					all_ascii = false
					break
			return DSLSeqIterator.new(obj, "str_ascii_iterator" if all_ascii else "str_iterator")
		if obj is DSLRange:
			return DSLSeqIterator.new(obj, "range_iterator")
		if obj is DSLDict or obj is DSLDefaultDict:
			return DSLSeqIterator.new(obj, "dict_keyiterator")
		if obj is DSLDictKeys:
			return DSLSeqIterator.new(obj, "dict_keyiterator")
		if obj is DSLDictValues:
			return DSLSeqIterator.new(obj, "dict_valueiterator")
		if obj is DSLDictItems:
	...
	func _convert_to_int(arg: DSLObject, base_arg = null) -> DSLInteger:
		...
		if arg.klass != null:
			var method = arg.klass._lookup_method("__int__")
			if method == null:
				method = arg.klass._lookup_method("__index__")
			if method != null:
				var res = arg.klass._invoke_func(method, [arg] as Array[DSLObject], {} as Dictionary[String, DSLObject])
				if res == null:
					return null
	...
	func api_bytes_new(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		...
		if args.size() >= 2:
			...
			if raw is DSLInteger:
				...
				for b in buf:
					out.append(b)
			elif raw is DSLList or raw is DSLTuple:
				for it in raw.items:
					if it is DSLInteger:
						var v = it.value
						if v < 0 or v > 255:
				...
				return null
		var result = DSLBytes.new(out)
		result.klass = args[0]
		return result

	func api_int_from_bytes(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		# 注册为类属性内建: args[0] 为字节串, args[1] 为字节序 (不携带 cls 前缀)
		var raw = DSLObject._unwrap_dsl(args[0] if args.size() >= 1 else null)
		var bytes_data: Array[int] = []
		if raw is DSLBytes:
			bytes_data = raw.data
		elif raw is DSLString:
			for ch in raw.value:
				bytes_data.append(ch.unicode_at(0))
		else:
			raise_exception("TypeError", "cannot convert '%s' object to bytes" % raw._type_name())
			return null
		var byteorder = "big"
		...
		if byteorder != "big" and byteorder != "little":
			raise_exception("ValueError", "byteorder must be either 'little' or 'big'")
			return null
		var signed = false
		if _kwargs.has("signed") and _kwargs["signed"] is DSLBool:
			signed = _kwargs["signed"].value
		if byteorder == "little":
			bytes_data = bytes_data.duplicate()
			bytes_data.reverse()
		var v = 0
		for b in bytes_data:
			v = (v << 8) | b
	...
	func builtin_format_value(args: Array[DSLObject], _kwargs: Dictionary[String, DSLObject]) -> DSLObject:
		if args.is_empty() or args.size() > 2:
			raise_exception("TypeError", "format() takes at most 2 arguments")
			return null
		var spec = ""
		if args.size() == 2 and args[1] is DSLString:
			spec = args[1].value
